"""
Port configuration utilities for Harmonia component.
...
def get_harmonia_port():
    """
    Get the configured port for the Harmonia component.
    
    Returns:
        int: The port number for Harmonia (default 8007)
    """
...
def verify_component_port(component_id: str) -> Tuple[bool, str]:
    ...
    Args:
        component_id (str): The component identifier (e.g., "harmonia", "hermes")
